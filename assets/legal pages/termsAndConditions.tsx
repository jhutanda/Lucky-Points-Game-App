    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.paragraph}>
          These terms and conditions applies to the Lucky points app (hereby referred to as "Application") for mobile
          devices that was created by Jhutan Da (hereby referred to as "Service
        ...
        <Text style={styles.listItem}>AdMob</Text>
        ...
        <Text style={styles.paragraph}>
          These terms and conditions are effective as of 2024-12-15
        </Text>
